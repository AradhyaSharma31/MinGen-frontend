...
export const UserPlaylists = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <div className="bg-gradient-home flex flex-col md:flex-row justify-center md:justify-start items-center md:space-x-10 px-6 md:px-10 py-10 md:h-[25rem]">
        <div className="gradient-home flex justify-center items-center rounded-full shadow-md shadow-[#2b2727] h-32 md:h-[50%] w-32 md:w-[10rem]">
          <FontAwesomeIcon
            className="h-1/3 hover:h-2/5 transition-all duration-200 ease-in-out"
            icon={faHouse}
